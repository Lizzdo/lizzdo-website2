...
export function createDefaultTextProps() {
  return {
    ...
    backgroundPadding: 12,
    backgroundBorderColor: "#00f5ff",
    backgroundBorderWidth: 0,
    backgroundCornerRadius: 8,
    backgroundIndependentCorners: false,
    backgroundCorners: { topLeft: 8, topRight: 8, bottomLeft: 8, bottomRight: 8 },
